	...
	<?php echo "<p>Get ready for more quality games. We will be adding new fresh games every week, so make sure you update our plugin.</p>"; ?>
...
<font size="2">HD Games</font><table style="width:100%;"  class="tg"><tr>
	...
	<p align="center">Thank you for using our plugin!</p>
	</div>
	</div>
