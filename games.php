...
echo '<div style="text-align: right;">Super Mario Land hosted fore free at <a href="http://critic.net/free-arcade-games/">http://critic.net/free-arcade-games/</a>.</div>' . "\n";
}
}
...
<?php
if (wgames_Main::$settings['wgames_author_linking'] == '1') {
echo '<div style="text-align: center;">Super mario bros hosted in <a href="http://critic.net/">http://critic.net/free-arcade-games/</a>.</div>' . "\n";
}
}
